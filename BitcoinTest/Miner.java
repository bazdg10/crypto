...
public class Miner { 
    ...
    private static List<Block> readFile() {
    ...
    private static void activateChildNode(List<Block> blocks) {
        ...
        while(!readyHashes.isEmpty()) {
            ...
            for (Block block : blocks) {
                if (block.getPar_id().equals(hashVal)) {
    ...
    public static int performTransaction(Block block) {
        ...
        try 
        {
            ...
            readyHashes.add(toHexString(getSHA(s)));            
    ...
    public static void main(String args[])
    {
        ...
        while (!blocks.isEmpty()||!readyBlocks.isEmpty()) {
            ...
            for (Block block : carryOut) {
                ...
                c++;
                System.out.println("Extracted: " + block.getId() + " " + c);
